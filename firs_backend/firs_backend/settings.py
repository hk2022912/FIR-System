"""
Django settings for firs_backend project.
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',        # ← Move CORS up here
...
# Static files — add this for WhiteNoise
STATIC_URL = '/static/'
...
EMAIL_PORT          = 587
EMAIL_USE_TLS       = True
EMAIL_HOST_USER     = 'operation.firs.2026@gmail.com'      # ← change this
EMAIL_HOST_PASSWORD = 'aotnebxrdhlinrvo'    # ← change this (App Password, not your real password)
